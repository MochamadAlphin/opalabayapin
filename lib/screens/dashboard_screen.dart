...
import '../pages/detail_wawancara.dart'; // 🎯 IMPORT PATH BARU DETAIL WAWANCARA
          ...
          child: Column(
            ...
            children: [
              ...
              if (_logic.isPimpinan) ...[
                ...
                const Text(
                  'Rincian data keterisian unit kamar dan status unit masing-masing rusunawa.',
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Expanded(child: _buildLocalItemStat("Perbaikan", (lokasiData['unit_perbaikan'] ?? 0).toString(), Colors.red)),
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 12),
                    _buildAgeProgressRow('Lansia (46-59 tahun)', _logic.jmlLansia, totalPgh, Colors.purple),
                    const SizedBox(height: 12),
                    _buildAgeProgressRow('Manula (≥60 tahun)', _logic.jmlManula, totalPgh, Colors.teal),
                  ],
                ),
              ),
              const SizedBox(height: 24),
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Container(
                        ...
                        child: Material(
                          ...
                          child: InkWell(
                            onTap: () {
                              // 🎯 SEKARANG MENGARAH KE POPUP MODAL DIALOG DETAIL WAWANCARA
                              showDialog(
                                context: context,
                                builder: (context) => DetailWawancaraPopup(pendaftar: pendaftar),
                              );
                            },
                            child: Padding(
